...
const BLOG = {
  // Important page_id！！！Duplicate Template from  https://https://www.notion.so/hubo1991/Bo-Hu-d0121c1709ca400fb7f524bf14722afd?pvs=4
  NOTION_PAGE_ID: process.env.NOTION_PAGE_ID || 'Bo-Hu-d0121c1709ca400fb7f524bf14722afd?pvs=4',
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '胡波的小站', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '一个普通人', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'http://mypage.zjnu.edu.cn/hubo/zh_CN/index.htm', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '博客', // 网站关键词 英文逗号隔开
  // 社交链接，不需要可留空白，例如 CONTACT_WEIBO:''
  CONTACT_EMAIL: process.env.NEXT_PUBLIC_CONTACT_EMAIL || 'jokerhubo@hotmail.com', // 邮箱地址 例如mail@tangly1024.com
